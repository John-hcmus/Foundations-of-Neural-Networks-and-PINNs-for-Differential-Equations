...
và Mục~\ref{sec:tn7} quét ba hạt giống.
...
được không đồng nghĩa với có ý nghĩa thống kê. Riêng Mục~\ref{sec:tn3} vẫn dùng
lấy mẫu ngẫu nhiên với một hạt giống duy nhất, nên các hệ số cải thiện báo cáo ở
đó chưa có khoảng tin cậy.
