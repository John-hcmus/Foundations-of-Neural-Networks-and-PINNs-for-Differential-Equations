...
% So trang dat o chan trang goc phai, nen dung `includefoot`: `bottom` do
% TU MEP GIAY TOI DAY CHAN TRANG (noi dat so trang). Nho vay ca hai cach
% do le duoi deu hop le -- do toi so trang duoc 2,5cm, do toi than chu thi
% con rong hon. Neu bo includefoot thi so trang tut xuong duoi muc 2cm,
% tuc vi pham san le duoi.
% Dau trang de trong, nen `top` do thang toi than chu: le tren = 2,5cm.
\usepackage[top=2.5cm, bottom=2.5cm, left=3cm, right=2cm,
            headheight=15pt, includefoot, footskip=0.8cm]{geometry}
\usepackage{setspace}
...
% Header / footer
% So trang dat o CHAN TRANG, GOC PHAI. Kieu `plain` (trang mo dau moi
% chuong) duoc dinh nghia lai giong het kieu chinh, de moi trang deu danh so
% cung mot cho -- neu khong, LaTeX se dat so trang o giua chan trang rieng
% o cac trang mo chuong.
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[R]{\thepage}
