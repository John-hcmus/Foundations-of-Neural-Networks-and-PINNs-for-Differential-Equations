...
và kiểm chứng từng phát biểu lý thuyết bằng chín thí nghiệm có tiêu chí thành bại
...
(Bổ đề~\ref{bd:phan-hoi-duong}). Việc lặp lại hai thí nghiệm chính trên năm hạt
giống còn loại bỏ được một tương quan mà chính luận văn đã ghi nhận trước đó
...
hạn $189$ lần ở cùng mức sai số, nên giá trị của phương pháp phải được biện minh
...
library and tests each theoretical claim through nine experiments with success
...
a positive-feedback failure mode. Repeating the two main experiments over five
random seeds further eliminated a correlation the thesis had itself recorded. A
direct cost measurement gives a further result worth stating plainly: on the one-dimensional problems studied here the
PINN is $189$ times slower than a finite-difference solver at the same accuracy,
so the value of the method must be argued from inverse problems, incomplete
boundary data and high dimension rather than from cost.
