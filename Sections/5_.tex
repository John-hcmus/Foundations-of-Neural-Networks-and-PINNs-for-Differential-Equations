...
đầy đủ cả những chỗ khớp lẫn những chỗ không khớp: trong mười hạng mục đối chiếu
...
Mục~\ref{sec:tn1}--\ref{sec:tn7} trình bày bảy thí nghiệm.
...
& chặn đúng $15/15$; nhưng số mũ của tỉ số quan sát được là
  ...
  $\nu = 0{,}01$
& \textbf{Chặn khớp, cơ chế không} (Nhận xét~\ref{nx:doc-tn7}) \\
\bottomrule
\end{tabular}
\end{table}
 
Trong mười hạng mục: năm khớp trọn vẹn, một khớp về hướng nhưng không rút được
kết luận định lượng, \emph{hai} cần siết lại cách phát biểu, một chỉ là tương
quan chưa giải thích được, và một cho kết quả tiêu cực nhưng đã truy được nguyên
nhân.
...
tương ứng với những chỗ luận văn dùng \emph{suy luận tiệm cận}, \emph{ghép hai
kết quả rời rạc}, hoặc đọc một \emph{chặn trên} như thể nó là cơ chế đang vận
hành:
...
số nào thắng; quan hệ $\rho_b$--$\norm{\bW^{(1)}}^2$ không có chứng minh nào cả; và tầng thứ
nhất của Bảng~\ref{tab:ba-nguyen-nhan} đọc hằng số của một chặn trên như thể nó
là cơ chế quyết định (Nhận xét~\ref{nx:doc-tn7}).
