...
\texttt{pinns/exp7\_nu\_sweep.py} & Mục~\ref{sec:tn7}, quét $\nu$ trên ba hạt
  giống \\
\texttt{pinns/exp8\_seeds.py} & lặp lại TN4 và TN5 trên nhiều hạt giống; chạy
  tiếp được sau khi bị ngắt, vì ghi kết quả sau mỗi hạt giống \\
\texttt{pinns/run\_all.py} & Chạy lần lượt cả bảy thí nghiệm \\
