...
hướng tiếp cận của luận văn~\cite{karniadakis2021}.
...
và sự phân loại này định vị chính xác phạm vi của luận văn.
...
Ba con đường này không loại trừ nhau. Luận văn tập trung vào con đường thứ ba, và
...
và chính các nhược điểm ấy chiếm phần lớn dung lượng của luận văn. Karniadakis và
...
Luận văn hướng tới việc trình bày một cách hệ thống nền tảng toán học, thuật toán
...
Hai chữ ``cân bằng'' cần được hiểu theo nghĩa mạnh. Luận văn báo cáo đầy đủ cả
những kết quả không đạt kỳ vọng, và trong một trường hợp, một kết quả tiêu cực đã
dẫn tới việc phải siết lại cách phát biểu của chính chương lý thuyết
(Nhận xét~\ref{nx:hieu-chinh}).
 
\subsection{Mục tiêu cụ thể}
 
Từ mục tiêu tổng quát, luận văn đặt ra năm nhiệm vụ.
...
Để bảo đảm chiều sâu, luận văn giới hạn phạm vi như sau.
...
Về \emph{cơ chế nhúng vật lý}, luận văn tập trung vào thiên kiến học, tức cưỡng
...
Về \emph{mô hình thời gian}, luận văn chỉ xét mô hình thời gian liên tục của
...
Cuối cùng, về \emph{tham vọng lý thuyết}: luận văn không đặt mục tiêu chứng minh
định lý mới về hội tụ hay ước lượng sai số cho PINNs, và các kết quả lớn của lĩnh
vực chỉ được trích dẫn cùng diễn giải. Tuy vậy, luận văn \emph{có} cung cấp chứng
...
Trong phạm vi đã nêu, luận văn có ba đóng góp.
...
kết luận phương pháp luận đáng chú ý: mọi hạng mục khớp trọn vẹn với thực nghiệm
đều tương ứng với một mệnh đề đã được chứng minh, còn mọi hạng mục phải điều chỉnh
đều tương ứng với chỗ suy luận tiệm cận hoặc ghép hai kết quả rời rạc.
...
kiểm chứng bằng năm thí nghiệm, mỗi thí nghiệm trả lời một câu hỏi cụ thể với tiêu
