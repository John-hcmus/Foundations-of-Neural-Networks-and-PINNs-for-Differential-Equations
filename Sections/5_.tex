...
đầy đủ cả những chỗ khớp lẫn những chỗ không khớp: trong mười hai hạng mục đối
chiếu ở Mục~\ref{sec:doi-chieu}, năm khớp trọn vẹn, một khớp về hướng nhưng
...
Trong mười hai hạng mục: năm khớp trọn vẹn, một khớp về hướng nhưng không rút
được kết luận định lượng, \emph{bốn} cần siết lại cách phát biểu, một không tái
...
theo \emph{nguồn gốc} của phát biểu thay vì theo kết quả. Ranh giới trùng khít:

\emph{Cả năm hạng mục khớp trọn vẹn đều tương ứng với một mệnh đề đã được chứng
minh} --- Hệ quả~\ref{hq:pinn-hong}, Mệnh đề~\ref{md:phat-bien-phat},
Mệnh đề~\ref{md:san-nhieu}, Mệnh đề~\ref{md:chan-on-dinh},
Mệnh đề~\ref{md:chi-phi-bp} --- và \emph{không một hạng mục nào phải siết lại là
chỗ một mệnh đề đã chứng minh bị số liệu bác bỏ}. Ngay cả
Mệnh đề~\ref{md:chan-suy-bien}, nằm trong nhóm có vấn đề, cũng đúng ở cả $15/15$
trường hợp; cái phải sửa là \emph{cách đọc} nó. Nói cách khác: trong toàn bộ
chương thực nghiệm, chứng minh chưa một lần thất bại; chỉ có suy đoán thất bại.

Bảy chỗ phải điều chỉnh chia thành bốn kiểu suy luận yếu hơn. \emph{Ghép hai
kết quả rời rạc}: giả thuyết \eqref{eq:pho-hieu-dung} nhân $\abs{P}^2$ với
$\widehat{\varkappa}$, và kết luận ở Mục~\ref{subsec:he-qua-pinn} ngầm giả định
thừa số nào thắng. \emph{Đọc một chặn trên như thể nó là cơ chế đang vận hành}:
tầng thứ nhất của Bảng~\ref{tab:ba-nguyen-nhan} (Nhận xét~\ref{nx:doc-tn7}).
\emph{Khái quát hoá từ một lần chạy}: quan hệ $\rho_b$--$\norm{\bW^{(1)}}^2$
không sống sót qua năm hạt giống (Nhận xét~\ref{nx:tuong-quan-hong}), và phát
biểu về chiều biến thiên của $\rho_b$ trên bài toán lành mạnh chỉ đúng ở $3/5$
hạt giống (Mục~\ref{sec:tn8}). Cuối cùng, \emph{ước lượng bậc độ lớn không được
kiểm chứng}: Nhận xét~\ref{nx:chi-phi-bac-cao} đoán bội số $4$--$6$ trong khi đo
được khoảng $9$ (Mục~\ref{sec:tn9}).
...
cho con số bất lợi nhất của luận văn: PINN chậm hơn sai phân hữu hạn khoảng bốn
