...
\emph{tiệm cận}; và trong cả hai trường hợp luận văn đã đối chiếu một số mũ đo
...
không lặp là bốn con số sai trong một luận văn.}
\end{nhanxet}
...
\emph{Không một mệnh đề đã chứng minh nào bị số liệu bác bỏ.} Bốn mệnh đề được
xác nhận trọn vẹn (Hệ quả~\ref{hq:pinn-hong}, Mệnh đề~\ref{md:san-nhieu},
Mệnh đề~\ref{md:chan-on-dinh}, Mệnh đề~\ref{md:chi-phi-bp}), và hai mệnh đề còn
lại --- Mệnh đề~\ref{md:phat-bien-phat} và Mệnh đề~\ref{md:chan-suy-bien} ---
đúng về \emph{hướng} ở mọi hạt giống và mọi giá trị $\nu$; cái phải sửa ở cả hai
là \emph{cách đọc}, không phải nội dung. Trong toàn bộ chương thực nghiệm, chứng
minh chưa một lần thất bại; chỉ có suy đoán thất bại.

Tám chỗ phải điều chỉnh chia thành bốn kiểu suy luận yếu hơn.

\emph{Đối chiếu một số mũ đo ở ngân sách hữu hạn với số mũ tiệm cận.} Đây là
...
\emph{Ghép hai kết quả rời rạc}: giả thuyết \eqref{eq:pho-hieu-dung} nhân
...
giống; và tỉ số $\abs{c_1}/\abs{c_8} = 38{,}6$ thuộc đuôi hiếm của một phân bố
có trung vị $5{,}5$ (Mục~\ref{sec:tn8}).

\emph{Ước lượng bậc độ lớn không được kiểm chứng}: Nhận xét~\ref{nx:chi-phi-bac-cao}
...
chúng: mỗi ô số liệu nên là ``trung vị $[\min;\max]$'' ngay tại chỗ. Luận văn
...
dạng khác nhau, và cả hai chỉ lộ ra khi cài đặt lại từ chính mô tả trong luận
văn (Phụ lục~\ref{app:code}).

\emph{Dạng thứ nhất --- lấy mẫu ngẫu nhiên, chỉ ghi số lượng.} TN4 và TN5 lấy
điểm phối trí ngẫu nhiên, nhưng luận văn chỉ ghi \emph{số lượng} điểm chứ không
