...
gói sẵn (lý do ở Nhận xét~\ref{nx:vi-sao-tu-viet}), và được công bố kèm luận văn
...
pháp: trên bài toán Burgers một chiều, PINN cần $183{,}6$ giây để đạt sai số
$8{,}19\times10^{-2}$, trong khi bộ giải sai phân hữu hạn đạt cùng mức sai số
trong $0{,}97$ giây --- chậm hơn $189$ lần, và tỉ số này còn là ước lượng có lợi
cho PINN. Đây không phải mâu thuẫn với Chương~\ref{chap:modau}: cả ba động lực
...
luận văn thực nghiệm. Kết luận đúng phạm vi là: các thí nghiệm ở đây kiểm chứng
...
ấy để \emph{loại bỏ} hai kết luận mà các mục trước đã rút ra --- đúng vai trò mà
...
đáng chú ý: trong mười hai hạng mục, \emph{không} hạng mục nào phải điều chỉnh
lại tương ứng với một mệnh đề đã được chứng minh. Cả năm chỗ phải siết lại đều
đến từ ba kiểu suy luận yếu hơn --- suy luận tiệm cận, ghép hai kết quả rời rạc,
và khái quát hoá từ một lần chạy duy nhất.

Bên cạnh ba đóng góp đã dự kiến, quá trình thực nghiệm sinh thêm bốn kết quả
không nằm trong kế hoạch ban đầu, và cả bốn đều xuất phát từ \emph{kết quả tiêu
cực}:
...
\item \textbf{Một chế độ hỏng chứng minh được của quy tắc cân bằng trọng số.}
      ...
      bởi thực nghiệm.
\item \textbf{Một tương quan bị chính luận văn bác bỏ.} Mục~\ref{sec:tn5} ghi
      nhận rằng $\rho_b$ và $\norm{\bW^{(1)}}_F^2$ cùng tăng, và nói rõ đó chỉ là
      quan sát trên một lần chạy. Mục~\ref{sec:tn8} kiểm chứng chính điều đó trên
      năm hạt giống: hệ số tương quan trên thang log chỉ còn $0{,}24$, và phát
      biểu về chiều biến thiên của $\rho_b$ trên bài toán lành mạnh cũng chỉ đúng
      ở $3/5$ hạt giống (Nhận xét~\ref{nx:tuong-quan-hong}). Giá trị của kết quả
      này không nằm ở bản thân tương quan mà ở \emph{quy trình}: nó cho thấy chi
      phí của việc lặp năm hạt giống --- khoảng một giờ máy --- rẻ hơn hẳn cái
      giá của hai kết luận sai.
\end{itemize}
...
vì vậy \emph{không} được kiểm chứng bằng thực nghiệm nào trong luận văn. Phép đo
...
hai bậc về chi phí, và luận văn không có bài toán nào để cho thấy tỉ số ấy đảo
chiều.
...
đã được làm: Mục~\ref{sec:tn8} lặp TN4 và TN5 trên năm hạt giống, và riêng nó đã
loại được một tương quan sai. Việc còn thiếu là chạy nốt TN3 --- thí nghiệm ngẫu
nhiên duy nhất chưa được lặp --- theo cùng quy trình. Hai việc rẻ khác: áp dụng
lấy mẫu thích nghi RAR cho bài toán Burgers, nơi Mục~\ref{sec:tn8} cho thấy sai
số trải tới $26$ lần giữa các hạt giống nên dư địa cải thiện là lớn;
...
$d$ mà tỉ số $189$ lần đảo chiều. Chừng nào chưa có con số đó, ưu thế của PINNs
