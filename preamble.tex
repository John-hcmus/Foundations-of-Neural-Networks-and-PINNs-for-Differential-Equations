...
% Hoặc nếu đã nạp geometry từ trước:
...
\usepackage{bm}        % Hỗ trợ in đậm ký hiệu toán học đẹp hơn
\usepackage{mathtools} % Hỗ trợ định nghĩa \abs chuẩn giãn cách

% 1. Sửa lỗi chung \bk (chọn một trong hai cách dưới)
\newcommand{\bk}{\mathbf{k}}  % Cách 1: dùng \mathbf thông thường
% \newcommand{\bk}{\bm{k}}    % Cách 2: dùng \bm (đẹp hơn nếu k là biến nghiêng đậm)

% 2. Phòng ngừa lỗi \abs
\DeclarePairedDelimiter\abs{\lvert}{\rvert}
% Hoặc nếu không muốn dùng mathtools:
