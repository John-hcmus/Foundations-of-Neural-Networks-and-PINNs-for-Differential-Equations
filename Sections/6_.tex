...
bị số liệu bác bỏ. Cả tám chỗ phải siết lại đều đến từ bốn kiểu suy luận yếu
hơn --- đối chiếu một số mũ đo ở ngân sách hữu hạn với số mũ tiệm cận, ghép hai
kết quả rời rạc, khái quát hoá từ một lần chạy duy nhất, và ước lượng bậc độ lớn
chưa kiểm chứng.
...
\item \textbf{Một chế độ hỏng chứng minh được của quy tắc cân bằng trọng số.}
      ...
      bởi thực nghiệm.
\item \textbf{Bốn con số của chính luận văn bị chính luận văn loại bỏ.}
...
áp dụng lấy mẫu thích nghi RAR cho bài toán Burgers, nơi Mục~\ref{sec:tn8} cho
thấy sai số trải tới $26$ lần giữa các hạt giống nên dư địa cải thiện là lớn;
